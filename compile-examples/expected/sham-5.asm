...
L62: ; Continuation
  ;; (110'35) Tail: put_chars (g25) @ xs (f2)
  mov dx, [bp+2]
  mov bp, #g25
  mov ax, [bp]
  jmp [ax]
...
L69: ; Continuation
  ;; (89'10) Tail: implode (f2) @ app_44'31 (arg)
  mov bp, [bp+2]
  mov dx, dx
  mov ax, [bp]
  jmp [ax]
...
L78: ; Arm: 149'11
  ...
  push #L77
  mov cx, sp
  ;; (149'26) Tail: rev_implode (f1) @ accCs (f5)
  mov dx, [bp+5]
  mov bp, [bp+1]
  mov ax, [bp]
  jmp [ax]
...
L79: ; Continuation
  ;; (151'74) Tail: app_151'45 (arg) @ xs (f2)
  ;; use temp ax while setting up bp/dx
  mov ax, bp
  mov bp, dx
  mov dx, [ax+2]
...
L80: ; Continuation
  ...
  push #L79
  mov cx, sp
  ;; (151'45) Tail: at_word_start (f2) @ con_0'0 (t1)
  mov bp, [bp+2]
  mov dx, [1]
  mov ax, [bp]
  jmp [ax]
...
L81: ; Arm: 151'26
  ...
  push #L80
  mov cx, sp
  ;; (151'58) Tail: rev_implode (f1) @ accCs (f5)
  mov dx, [bp+5]
  mov bp, [bp+1]
  mov ax, [bp]
  jmp [ax]
...
L82: ; Continuation
  ;; (152'43) Tail: app_152'32 (arg) @ xs (f2)
  ;; use temp ax while setting up bp/dx
  mov ax, bp
  mov bp, dx
  mov dx, [ax+2]
...
L83: ; Continuation
  ...
  push #L82
  mov cx, sp
  ;; (152'32) Tail: app_152'26 (arg) @ con_0'0 (t1)
  mov bp, dx
  mov dx, [1]
  mov ax, [bp]
  jmp [ax]
...
L84: ; Function: t1
  ...
  push #L83
  mov cx, sp
  ;; (152'26) Tail: have_letter (f4) @ accWs (f3)
  mov dx, [bp+3]
  mov bp, [bp+4]
  mov ax, [bp]
  jmp [ax]
...
L88: ; Continuation
  ;; (158'49) Tail: app_158'43 (arg) @ xs (f2)
  ;; use temp ax while setting up bp/dx
  mov ax, bp
  mov bp, dx
  mov dx, [ax+2]
...
L89: ; Arm: 158'24
  ...
  push #L88
  mov cx, sp
  ;; (158'43) Tail: at_word_start (f2) @ accWs (f1)
  mov dx, [bp+1]
  mov bp, [bp+2]
  mov ax, [bp]
  jmp [ax]
...
L90: ; Continuation
  ;; (159'31) Tail: app_159'27 (arg) @ xs (f2)
  ;; use temp ax while setting up bp/dx
  mov ax, bp
  mov bp, dx
  mov dx, [ax+2]
...
L91: ; Continuation
  ...
  push #L90
  mov cx, sp
  ;; (159'27) Tail: app_159'21 (arg) @ con_159'28 (t1)
  mov bp, dx
  mov dx, [1]
  mov ax, [bp]
  jmp [ax]
...
L92: ; Function: t2
  ...
  push #L91
  mov cx, sp
  ;; (159'21) Tail: have_letter (f3) @ accWs (f1)
  mov dx, [bp+1]
  mov bp, [bp+3]
  mov ax, [bp]
  jmp [ax]
...
L94: ; Arm: 130'22
  ...
  call bios_put_char
  mov 4, ax
  ;; (130'51) Tail: rev_implode (f1) @ acc (arg)
  mov bp, [bp+1]
  mov dx, dx
  mov ax, [bp]
  jmp [ax]
...
L95: ; Arm: 131'28
  ...
  push #1
  mov 8, sp
  ;; (131'76) Tail: rev_implode (f1) @ con_0'0 (t8)
  mov bp, [bp+1]
  mov dx, [8]
  mov ax, [bp]
  jmp [ax]
...
L96: ; Arm: 132'19
  ;; (132'33) Tail: readloop (me) @ acc (arg)
  mov bp, bp
  mov dx, dx
  mov ax, [bp]
  jmp [ax]
...
L97: ; Arm: 135'17
  ;; (135'29) Tail: readloop (me) @ acc (arg)
  mov bp, bp
  mov dx, dx
  mov ax, [bp]
  jmp [ax]
...
L98: ; Continuation
  ...
  call bios_put_char
  mov 3, ax
  ;; (139'24) Tail: readloop (f2) @ tail (f3)
  mov dx, [bp+3]
  mov bp, [bp+2]
  mov ax, [bp]
  jmp [ax]
...
L103: ; Continuation
  ...
  push #1
  mov 1, sp
  ;; (141'34) Tail: readloop (f3) @ con_0'0 (t1)
  mov bp, [bp+3]
  mov dx, [1]
  mov ax, [bp]
  jmp [ax]
...
L109: ; Continuation
  ;; (213'13) Tail: mainloop (f2) @ fs (arg)
  mov bp, [bp+2]
  mov dx, dx
  mov ax, [bp]
  jmp [ax]
...
L114: ; Continuation
  ...
  push #L113
  mov cx, sp
  ;; (179'28) Tail: app_179'23 (arg) @ command (f2)
  ;; use temp ax while setting up bp/dx
  mov ax, bp
  mov bp, dx
  mov dx, [ax+2]
...
L115: ; Function: t3
  ...
  push #L114
  mov cx, sp
  ;; (179'23) Tail: eq_string (f1) @ name (t3)
  mov bp, [bp+1]
  mov dx, [3]
  mov ax, [bp]
  jmp [ax]
...
L117: ; Continuation
  ...
  push #L116
  mov cx, sp
  ;; (112'29) Tail: put_chars (g25) @ app_112'38 (arg)
  mov bp, #g25
  mov dx, dx
  mov ax, [bp]
  jmp [ax]
...
L120: ; Continuation
  ...
  push #L119
  mov cx, sp
  ;; (44'31) Tail: app_44'28 (f5) @ app_42'25 (arg)
  mov bp, [bp+5]
  mov dx, dx
  mov ax, [bp]
  jmp [ax]
...
L121: ; Continuation
  ...
  push #L120
  mov cx, sp
  ;; (42'25) Tail: app_42'22 (arg) @ xs (f6)
  ;; use temp ax while setting up bp/dx
  mov ax, bp
  mov bp, dx
  mov dx, [ax+6]
...
L122: ; Continuation
  ...
  push #L121
  mov cx, sp
  ;; (42'22) Tail: rev_onto (g8) @ con_42'22 (g46)
  mov bp, #g8
  mov dx, #g46
  mov ax, [bp]
  jmp [ax]
...
L125: ; Continuation
  ...
  push #L124
  mov cx, sp
  ;; (89'27) Tail: explode (f3) @ lit_194'26 (g45)
  mov bp, [bp+3]
  mov dx, #g45
  mov ax, [bp]
  jmp [ax]
...
L129: ; Continuation
  ...
  push #L128
  mov cx, sp
  ;; (42'22) Tail: rev_onto (g8) @ con_42'22 (g44)
  mov bp, #g8
  mov dx, #g44
  mov ax, [bp]
  jmp [ax]
...
L132: ; Continuation
  ...
  push #L131
  mov cx, sp
  ;; (89'27) Tail: explode (f3) @ command (f5)
  mov dx, [bp+5]
  mov bp, [bp+3]
  mov ax, [bp]
  jmp [ax]
...
L136: ; Continuation
  ...
  push #L135
  mov cx, sp
  ;; (42'22) Tail: rev_onto (g8) @ con_42'22 (g43)
  mov bp, #g8
  mov dx, #g43
  mov ax, [bp]
  jmp [ax]
...
L139: ; Continuation
  ...
  push #L138
  mov cx, sp
  ;; (89'27) Tail: explode (f3) @ lit_194'43 (g42)
  mov bp, [bp+3]
  mov dx, #g42
  mov ax, [bp]
  jmp [ax]
...
L143: ; Continuation
  ...
  push #L142
  mov cx, sp
  ;; (42'22) Tail: rev_onto (g8) @ con_42'22 (g41)
  mov bp, #g8
  mov dx, #g41
  mov ax, [bp]
  jmp [ax]
...
L145: ; Continuation
  ...
  push #L144
  mov cx, sp
  ;; (89'40) Tail: explode (f3) @ lit_194'50 (g40)
  mov bp, [bp+3]
  mov dx, #g40
  mov ax, [bp]
  jmp [ax]
...
L146: ; Arm: 196'9
  ...
  push #L145
  mov cx, sp
  ;; (89'27) Tail: explode (f3) @ lit_196'16 (g39)
  mov bp, [bp+3]
  mov dx, #g39
  mov ax, [bp]
  jmp [ax]
...
L153: ; Continuation
  ...
  push #L152
  mov cx, sp
  ;; (42'22) Tail: rev_onto (g8) @ con_42'22 (g54)
  mov bp, #g8
  mov dx, #g54
  mov ax, [bp]
  jmp [ax]
...
L156: ; Continuation
  ...
  push #L155
  mov cx, sp
  ;; (89'27) Tail: explode (f3) @ lit_194'26 (g53)
  mov bp, [bp+3]
  mov dx, #g53
  mov ax, [bp]
  jmp [ax]
...
L160: ; Continuation
  ...
  push #L159
  mov cx, sp
  ;; (42'22) Tail: rev_onto (g8) @ con_42'22 (g52)
  mov bp, #g8
  mov dx, #g52
  mov ax, [bp]
  jmp [ax]
...
L165: ; Continuation
  ...
  push #L164
  mov cx, sp
  ;; (44'31) Tail: app_44'28 (f6) @ app_42'25 (arg)
  mov bp, [bp+6]
  mov dx, dx
  mov ax, [bp]
  jmp [ax]
...
L167: ; Continuation
  ...
  push #L166
  mov cx, sp
  ;; (42'22) Tail: rev_onto (g8) @ con_42'22 (g51)
  mov bp, #g8
  mov dx, #g51
  mov ax, [bp]
  jmp [ax]
...
L170: ; Continuation
  ...
  push #L169
  mov cx, sp
  ;; (89'27) Tail: explode (f3) @ lit_194'43 (g50)
  mov bp, [bp+3]
  mov dx, #g50
  mov ax, [bp]
  jmp [ax]
...
L174: ; Continuation
  ...
  push #L173
  mov cx, sp
  ;; (42'22) Tail: rev_onto (g8) @ con_42'22 (g49)
  mov bp, #g8
  mov dx, #g49
  mov ax, [bp]
  jmp [ax]
...
L176: ; Continuation
  ...
  push #L175
  mov cx, sp
  ;; (89'40) Tail: explode (f3) @ lit_194'50 (g48)
  mov bp, [bp+3]
  mov dx, #g48
  mov ax, [bp]
  jmp [ax]
...
L177: ; Arm: 199'14
  ...
  push #L176
  mov cx, sp
  ;; (89'27) Tail: explode (f3) @ lit_199'21 (g47)
  mov bp, [bp+3]
  mov dx, #g47
  mov ax, [bp]
  jmp [ax]
...
L178: ; Continuation
  ;; (200'32) Tail: app_200'29 (arg) @ args (f2)
  ;; use temp ax while setting up bp/dx
  mov ax, bp
  mov bp, dx
  mov dx, [ax+2]
...
L180: ; Continuation
  ...
  push #L179
  mov cx, sp
  ;; (181'17) Tail: loop (f7) @ case_170'18 (arg)
  mov bp, [bp+7]
  mov dx, dx
  mov ax, [bp]
  jmp [ax]
...
L184: ; Continuation
  ...
  push #L183
  mov cx, sp
  ;; (162'33) Tail: app_162'30 (f5) @ app_162'42 (arg)
  mov bp, [bp+5]
  mov dx, dx
  mov ax, [bp]
  jmp [ax]
...
L185: ; Continuation
  ...
  push #L184
  mov cx, sp
  ;; (162'42) Tail: explode (f3) @ line (f7)
  mov dx, [bp+7]
  mov bp, [bp+3]
  mov ax, [bp]
  jmp [ax]
...
L186: ; Continuation
  ...
  push #L185
  mov cx, sp
  ;; (162'30) Tail: at_word_start (f5) @ con_162'30 (g36)
  mov bp, [bp+5]
  mov dx, #g36
  mov ax, [bp]
  jmp [ax]
...
L187: ; Continuation
  ...
  push #L186
  mov cx, sp
  ;; (211'20) Tail: app_211'15 (arg) @ single_controlD (f8)
  ;; use temp ax while setting up bp/dx
  mov ax, bp
  mov bp, dx
  mov dx, [ax+8]
...
L188: ; Continuation
  ...
  push #L187
  mov cx, sp
  ;; (211'15) Tail: eq_string (f4) @ line (arg)
  mov bp, [bp+4]
  mov dx, dx
  mov ax, [bp]
  jmp [ax]
...
L189: ; Continuation
  ...
  push #L188
  mov cx, sp
  ;; (143'11) Tail: readloop (t1) @ con_143'11 (g34)
  mov bp, [1]
  mov dx, #g34
  mov ax, [bp]
  jmp [ax]
...
L190: ; Continuation
  ...
  push #L189
  mov cx, sp
  ;; (209'32) Tail: implode (f2) @ con_0'0 (t1)
  mov bp, [bp+2]
  mov dx, [1]
  mov ax, [bp]
  jmp [ax]
...
L192: ; Function: t3
  ...
  push #L191
  mov cx, sp
  ;; (112'38) Tail: explode (f3) @ lit_208'13 (g28)
  mov bp, [bp+3]
  mov dx, #g28
  mov ax, [bp]
  jmp [ax]
...
L195: ; Arm: 217'9
  ...
  push #L194
  mov cx, sp
  ;; (112'38) Tail: explode (f1) @ lit_217'23 (g62)
  mov bp, [bp+1]
  mov dx, #g62
  mov ax, [bp]
  jmp [ax]
...
L205: ; Continuation
  ...
  push #L204
  mov cx, sp
  ;; (221'43) Tail: app_221'33 (f4) @ case_170'18 (arg)
  mov bp, [bp+4]
  mov dx, dx
  mov ax, [bp]
  jmp [ax]
...
L207: ; Function: t1
  ...
  push #L206
  mov cx, sp
  ;; (221'33) Tail: map (g3) @ lam_220'19 (g63)
  mov bp, #g3
  mov dx, #g63
  mov ax, [bp]
  jmp [ax]
...
L211: ; Arm: 233'7
  ...
  push #L210
  mov cx, sp
  ;; (112'38) Tail: explode (f1) @ lit_233'22 (g68)
  mov bp, [bp+1]
  mov dx, #g68
  mov ax, [bp]
  jmp [ax]
...
L215: ; Continuation
  ...
  push #L214
  mov cx, sp
  ;; (179'28) Tail: app_179'23 (arg) @ x (f2)
  ;; use temp ax while setting up bp/dx
  mov ax, bp
  mov bp, dx
  mov dx, [ax+2]
...
L224: ; Arm: 226'11
  ...
  push #L223
  mov cx, sp
  ;; (226'33) Tail: concat (f3) @ con_226'34 (t2)
  mov bp, [bp+3]
  mov dx, [2]
  mov ax, [bp]
  jmp [ax]
...
L229: ; Continuation
  ...
  push #L228
  mov cx, sp
  ;; (230'48) Tail: concat (f3) @ con_230'49 (t5)
  mov bp, [bp+3]
  mov dx, [5]
  mov ax, [bp]
  jmp [ax]
...
L230: ; Continuation
  ...
  push #L229
  mov cx, sp
  ;; (181'17) Tail: loop (f5) @ case_170'18 (arg)
  mov bp, [bp+5]
  mov dx, dx
  mov ax, [bp]
  jmp [ax]
...
L234: ; Continuation
  ...
  push #L233
  mov cx, sp
  ;; (234'27) Tail: iter (g5) @ lam_224'11 (t1)
  mov bp, #g5
  mov dx, [1]
  mov ax, [bp]
  jmp [ax]
...
L237: ; Arm: 226'11
  ...
  push #L236
  mov cx, sp
  ;; (226'33) Tail: concat (f4) @ con_226'34 (t2)
  mov bp, [bp+4]
  mov dx, [2]
  mov ax, [bp]
  jmp [ax]
...
L242: ; Continuation
  ...
  push #L241
  mov cx, sp
  ;; (230'48) Tail: concat (f4) @ con_230'49 (t5)
  mov bp, [bp+4]
  mov dx, [5]
  mov ax, [bp]
  jmp [ax]
...
L243: ; Continuation
  ...
  push #L242
  mov cx, sp
  ;; (181'17) Tail: loop (f8) @ case_170'18 (arg)
  mov bp, [bp+8]
  mov dx, dx
  mov ax, [bp]
  jmp [ax]
...
L248: ; Arm: 247'7
  ...
  push #L247
  mov cx, sp
  ;; (112'38) Tail: explode (f1) @ lit_247'22 (g89)
  mov bp, [bp+1]
  mov dx, #g89
  mov ax, [bp]
  jmp [ax]
...
L257: ; Continuation
  ...
  push #L256
  mov cx, sp
  ;; (179'28) Tail: app_179'23 (arg) @ name (f2)
  ;; use temp ax while setting up bp/dx
  mov ax, bp
  mov bp, dx
  mov dx, [ax+2]
...
L261: ; Arm: 240'11
  ...
  push #L260
  mov cx, sp
  ;; (238'35) Tail: concat (f3) @ con_238'36 (t2)
  mov bp, [bp+3]
  mov dx, [2]
  mov ax, [bp]
  jmp [ax]
...
L264: ; Arm: 243'16
  ...
  push #L263
  mov cx, sp
  ;; (238'35) Tail: concat (f3) @ con_238'36 (t4)
  mov bp, [bp+3]
  mov dx, [4]
  mov ax, [bp]
  jmp [ax]
...
L266: ; Continuation
  ...
  push #L265
  mov cx, sp
  ;; (112'38) Tail: explode (f2) @ meta (t2)
  mov bp, [bp+2]
  mov dx, [2]
  mov ax, [bp]
  jmp [ax]
...
L271: ; Continuation
  ...
  push #L270
  mov cx, sp
  ;; (248'27) Tail: iter (g5) @ lam_237'11 (t1)
  mov bp, #g5
  mov dx, [1]
  mov ax, [bp]
  jmp [ax]
...
L274: ; Arm: 240'11
  ...
  push #L273
  mov cx, sp
  ;; (238'35) Tail: concat (f4) @ con_238'36 (t2)
  mov bp, [bp+4]
  mov dx, [2]
  mov ax, [bp]
  jmp [ax]
...
L277: ; Arm: 243'16
  ...
  push #L276
  mov cx, sp
  ;; (238'35) Tail: concat (f4) @ con_238'36 (t4)
  mov bp, [bp+4]
  mov dx, [4]
  mov ax, [bp]
  jmp [ax]
...
L285: ; Arm: 265'7
  ...
  push #L284
  mov cx, sp
  ;; (112'38) Tail: explode (f1) @ lit_265'22 (g110)
  mov bp, [bp+1]
  mov dx, #g110
  mov ax, [bp]
  jmp [ax]
...
L289: ; Arm: 253'9
  ...
  push #L288
  mov cx, sp
  ;; (254'26) Tail: concat (f3) @ con_254'27 (t2)
  mov bp, [bp+3]
  mov dx, [2]
  mov ax, [bp]
  jmp [ax]
...
L293: ; Continuation
  ...
  push #L292
  mov cx, sp
  ;; (258'28) Tail: app_258'23 (arg) @ sought (f2)
  ;; use temp ax while setting up bp/dx
  mov ax, bp
  mov bp, dx
  mov dx, [ax+2]
...
L294: ; Function: t1
  ...
  push #L293
  mov cx, sp
  ;; (258'23) Tail: eq_string (f2) @ name (t3)
  mov bp, [bp+2]
  mov dx, [3]
  mov ax, [bp]
  jmp [ax]
...
L296: ; Continuation
  ...
  push #L295
  mov cx, sp
  ;; (260'17) Tail: loop (f2) @ case_170'18 (arg)
  mov bp, [bp+2]
  mov dx, dx
  mov ax, [bp]
  jmp [ax]
...
L299: ; Continuation
  ;; (266'29) Tail: app_266'26 (arg) @ args (f2)
  ;; use temp ax while setting up bp/dx
  mov ax, bp
  mov bp, dx
  mov dx, [ax+2]
...
L300: ; Continuation
  ...
  push #L299
  mov cx, sp
  ;; (266'26) Tail: app_266'22 (arg) @ fs (f2)
  ;; use temp ax while setting up bp/dx
  mov ax, bp
  mov bp, dx
  mov dx, [ax+2]
...
L301: ; Function: t1
  ...
  push #L300
  mov cx, sp
  ;; (266'22) Tail: fold_left (g7) @ lam_250'8 (t3)
  mov bp, #g7
  mov dx, [3]
  mov ax, [bp]
  jmp [ax]
...
L305: ; Arm: 270'7
  ...
  push #L304
  mov cx, sp
  ;; (112'38) Tail: explode (f1) @ lit_270'22 (g118)
  mov bp, [bp+1]
  mov dx, #g118
  mov ax, [bp]
  jmp [ax]
...
L309: ; Arm: 273'10
  ...
  push #L308
  mov cx, sp
  ;; (273'33) Tail: concat (f3) @ con_273'34 (t4)
  mov bp, [bp+3]
  mov dx, [4]
  mov ax, [bp]
  jmp [ax]
...
L312: ; Arm: 276'12
  ...
  push #L311
  mov cx, sp
  ;; (112'38) Tail: explode (f1) @ lit_276'27 (g123)
  mov bp, [bp+1]
  mov dx, #g123
  mov ax, [bp]
  jmp [ax]
...
L316: ; Continuation
  ...
  push #L315
  mov cx, sp
  ;; (179'28) Tail: app_179'23 (arg) @ source (f2)
  ;; use temp ax while setting up bp/dx
  mov ax, bp
  mov bp, dx
  mov dx, [ax+2]
...
L321: ; Arm: 279'15
  ...
  push #L320
  mov cx, sp
  ;; (279'38) Tail: concat (f3) @ con_279'39 (t2)
  mov bp, [bp+3]
  mov dx, [2]
  mov ax, [bp]
  jmp [ax]
...
L329: ; Arm: 285'7
  ...
  push #L328
  mov cx, sp
  ;; (112'38) Tail: explode (f1) @ lit_285'22 (g131)
  mov bp, [bp+1]
  mov dx, #g131
  mov ax, [bp]
  jmp [ax]
...
L333: ; Arm: 288'10
  ...
  push #L332
  mov cx, sp
  ;; (288'33) Tail: concat (f3) @ con_288'34 (t4)
  mov bp, [bp+3]
  mov dx, [4]
  mov ax, [bp]
  jmp [ax]
...
L336: ; Arm: 291'12
  ...
  push #L335
  mov cx, sp
  ;; (112'38) Tail: explode (f1) @ lit_291'27 (g136)
  mov bp, [bp+1]
  mov dx, #g136
  mov ax, [bp]
  jmp [ax]
...
L345: ; Arm: 294'15
  ...
  push #L344
  mov cx, sp
  ;; (294'38) Tail: concat (f4) @ con_294'39 (t2)
  mov bp, [bp+4]
  mov dx, [2]
  mov ax, [bp]
  jmp [ax]
...
L353: ; Continuation
  ...
  push #L352
  mov cx, sp
  ;; (258'28) Tail: app_258'23 (arg) @ source (f2)
  ;; use temp ax while setting up bp/dx
  mov ax, bp
  mov bp, dx
  mov dx, [ax+2]
...
L356: ; Continuation
  ...
  push #L355
  mov cx, sp
  ;; (260'17) Tail: loop (f4) @ case_170'18 (arg)
  mov bp, [bp+4]
  mov dx, dx
  mov ax, [bp]
  jmp [ax]
...
L361: ; Continuation
  ...
  push #0
  mov 26, sp
  ;; (319'11) Tail: mainloop (f5) @ con_306'13 (t26)
  mov bp, [bp+5]
  mov dx, [26]
  mov ax, [bp]
  jmp [ax]
...
L363: ; Continuation
  ...
  push #L362
  mov cx, sp
  ;; (112'38) Tail: explode (f4) @ lit_318'13 (g55)
  mov bp, [bp+4]
  mov dx, #g55
  mov ax, [bp]
  jmp [ax]

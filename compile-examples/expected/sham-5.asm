...
L27: ; Continuation
  ...
  push #L26
  mov cx, sp
  ;; (40'28) Tail: app_40'25 (arg) @ ys (f2)
  ;; use temp ax while setting up bp/dx
  mov ax, bp
  mov bp, dx
  mov dx, [ax+2]
...
L31: ; Continuation
  ;; (46'34) Tail: app_46'23 (arg) @ xs (f2)
  ;; use temp ax while setting up bp/dx
  mov ax, bp
  mov bp, dx
  mov dx, [ax+2]
...
L32: ; Function: t1
  ...
  push #L31
  mov cx, sp
  ;; (46'23) Tail: revloop (g9) @ con_0'0 (t3)
  mov bp, #g9
  mov dx, [3]
  mov ax, [bp]
  jmp [ax]
...
L35: ; Continuation
  ;; (57'43) Tail: app_57'37 (arg) @ xs (f2)
  ;; use temp ax while setting up bp/dx
  mov ax, bp
  mov bp, dx
  mov dx, [ax+2]
...
L36: ; Function: t1
  ...
  push #L35
  mov cx, sp
  ;; (57'37) Tail: loop (f3) @ prim_0'0 (t4)
  mov bp, [bp+3]
  mov dx, [4]
  mov ax, [bp]
  jmp [ax]
...
L43: ; Continuation
  ;; (68'43) Tail: app_68'37 (arg) @ xs (f2)
  ;; use temp ax while setting up bp/dx
  mov ax, bp
  mov bp, dx
  mov dx, [ax+2]
...
L44: ; Function: t1
  ...
  push #L43
  mov cx, sp
  ;; (68'37) Tail: loop (f3) @ prim_0'0 (t4)
  mov bp, [bp+3]
  mov dx, [4]
  mov ax, [bp]
  jmp [ax]
...
L51: ; Continuation
  ...
  sub ax, #1
  mov 1, ax
  ;; (76'45) Tail: app_76'19 (arg) @ prim_0'0 (t1)
  mov bp, dx
  mov dx, [1]
  mov ax, [bp]
  jmp [ax]
...
L52: ; Function: t1
  ...
  push #L51
  mov cx, sp
  ;; (76'19) Tail: explode_loop (f3) @ con_0'0 (t3)
  mov bp, [bp+3]
  mov dx, [3]
  mov ax, [bp]
  jmp [ax]
...
L54: ; Continuation
  ...
  sub ax, #1
  mov 1, ax
  ;; (78'18) Tail: app_78'15 (arg) @ prim_0'0 (t1)
  mov bp, dx
  mov dx, [1]
  mov ax, [bp]
  jmp [ax]
...
L55: ; Function: g15
  ...
  push #L54
  mov cx, sp
  ;; (78'15) Tail: explode_loop (t1) @ con_78'15 (g14)
  mov bp, [1]
  mov dx, #g14
  mov ax, [bp]
  jmp [ax]
...
L59: ; Continuation
  ...
  sub ax, #1
  mov 1, ax
  ;; (88'52) Tail: loop (f3) @ prim_0'0 (t1)
  mov bp, [bp+3]
  mov dx, [1]
  mov ax, [bp]
  jmp [ax]
...
L74: ; Continuation
  ;; (92'34) Tail: implode (f2) @ app_92'55 (arg)
  mov bp, [bp+2]
  mov dx, dx
  mov ax, [bp]
  jmp [ax]
...
L75: ; Continuation
  ...
  push #L74
  mov cx, sp
  ;; (92'55) Tail: app_92'42 (f3) @ app_92'64 (arg)
  mov bp, [bp+3]
  mov dx, dx
  mov ax, [bp]
  jmp [ax]
...
L77: ; Continuation
  ...
  push #L76
  mov cx, sp
  ;; (92'42) Tail: append (g8) @ app_92'51 (arg)
  mov bp, #g8
  mov dx, dx
  mov ax, [bp]
  jmp [ax]
...
L81: ; Arm: 152'11
  ...
  push #L80
  mov cx, sp
  ;; (152'30) Tail: reverse_implode (f1) @ accCs (f5)
  mov dx, [bp+5]
  mov bp, [bp+1]
  mov ax, [bp]
  jmp [ax]
...
L82: ; Continuation
  ;; (154'78) Tail: app_154'45 (arg) @ xs (f2)
  ;; use temp ax while setting up bp/dx
  mov ax, bp
  mov bp, dx
  mov dx, [ax+2]
...
L83: ; Continuation
  ...
  push #L82
  mov cx, sp
  ;; (154'45) Tail: at_word_start (f2) @ con_0'0 (t1)
  mov bp, [bp+2]
  mov dx, [1]
  mov ax, [bp]
  jmp [ax]
...
L84: ; Arm: 154'26
  ...
  push #L83
  mov cx, sp
  ;; (154'62) Tail: reverse_implode (f1) @ accCs (f5)
  mov dx, [bp+5]
  mov bp, [bp+1]
  mov ax, [bp]
  jmp [ax]
...
L85: ; Continuation
  ;; (155'43) Tail: app_155'32 (arg) @ xs (f2)
  ;; use temp ax while setting up bp/dx
  mov ax, bp
  mov bp, dx
  mov dx, [ax+2]
...
L86: ; Continuation
  ...
  push #L85
  mov cx, sp
  ;; (155'32) Tail: app_155'26 (arg) @ con_0'0 (t1)
  mov bp, dx
  mov dx, [1]
  mov ax, [bp]
  jmp [ax]
...
L87: ; Function: t1
  ...
  push #L86
  mov cx, sp
  ;; (155'26) Tail: have_letter (f4) @ accWs (f3)
  mov dx, [bp+3]
  mov bp, [bp+4]
  mov ax, [bp]
  jmp [ax]
...
L91: ; Continuation
  ;; (161'49) Tail: app_161'43 (arg) @ xs (f2)
  ;; use temp ax while setting up bp/dx
  mov ax, bp
  mov bp, dx
  mov dx, [ax+2]
...
L92: ; Arm: 161'24
  ...
  push #L91
  mov cx, sp
  ;; (161'43) Tail: at_word_start (f2) @ accWs (f1)
  mov dx, [bp+1]
  mov bp, [bp+2]
  mov ax, [bp]
  jmp [ax]
...
L93: ; Continuation
  ;; (162'31) Tail: app_162'27 (arg) @ xs (f2)
  ;; use temp ax while setting up bp/dx
  mov ax, bp
  mov bp, dx
  mov dx, [ax+2]
...
L94: ; Continuation
  ...
  push #L93
  mov cx, sp
  ;; (162'27) Tail: app_162'21 (arg) @ con_162'28 (t1)
  mov bp, dx
  mov dx, [1]
  mov ax, [bp]
  jmp [ax]
...
L95: ; Function: t2
  ...
  push #L94
  mov cx, sp
  ;; (162'21) Tail: have_letter (f3) @ accWs (f1)
  mov dx, [bp+1]
  mov bp, [bp+3]
  mov ax, [bp]
  jmp [ax]
...
L97: ; Arm: 133'22
  ...
  call bios_put_char
  mov 4, ax
  ;; (133'55) Tail: reverse_implode (f1) @ acc (arg)
  mov bp, [bp+1]
  mov dx, dx
  mov ax, [bp]
  jmp [ax]
...
L98: ; Arm: 134'28
  ...
  push #1
  mov 8, sp
  ;; (134'80) Tail: reverse_implode (f1) @ con_0'0 (t8)
  mov bp, [bp+1]
  mov dx, [8]
  mov ax, [bp]
  jmp [ax]
...
L99: ; Arm: 135'19
  ;; (135'33) Tail: readloop (me) @ acc (arg)
  mov bp, bp
  mov dx, dx
  mov ax, [bp]
  jmp [ax]
...
L100: ; Arm: 138'17
  ;; (138'29) Tail: readloop (me) @ acc (arg)
  mov bp, bp
  mov dx, dx
  mov ax, [bp]
  jmp [ax]
...
L101: ; Continuation
  ...
  call bios_put_char
  mov 3, ax
  ;; (142'24) Tail: readloop (f2) @ tail (f3)
  mov dx, [bp+3]
  mov bp, [bp+2]
  mov ax, [bp]
  jmp [ax]
...
L106: ; Continuation
  ...
  push #1
  mov 1, sp
  ;; (144'34) Tail: readloop (f3) @ con_0'0 (t1)
  mov bp, [bp+3]
  mov dx, [1]
  mov ax, [bp]
  jmp [ax]
...
L112: ; Continuation
  ;; (216'13) Tail: mainloop (f2) @ fs (arg)
  mov bp, [bp+2]
  mov dx, dx
  mov ax, [bp]
  jmp [ax]
...
L117: ; Continuation
  ...
  push #L116
  mov cx, sp
  ;; (182'28) Tail: app_182'23 (arg) @ command (f2)
  ;; use temp ax while setting up bp/dx
  mov ax, bp
  mov bp, dx
  mov dx, [ax+2]
...
L118: ; Function: t3
  ...
  push #L117
  mov cx, sp
  ;; (182'23) Tail: eq_string (f1) @ name (t3)
  mov bp, [bp+1]
  mov dx, [3]
  mov ax, [bp]
  jmp [ax]
...
L122: ; Arm: 199'9
  ...
  push #L121
  mov cx, sp
  ;; (197'33) Tail: concat (f3) @ con_197'34 (t2)
  mov bp, [bp+3]
  mov dx, [2]
  mov ax, [bp]
  jmp [ax]
...
L126: ; Arm: 202'14
  ...
  push #L125
  mov cx, sp
  ;; (197'33) Tail: concat (f3) @ con_197'34 (t4)
  mov bp, [bp+3]
  mov dx, [4]
  mov ax, [bp]
  jmp [ax]
...
L127: ; Continuation
  ;; (203'32) Tail: app_203'29 (arg) @ args (f2)
  ;; use temp ax while setting up bp/dx
  mov ax, bp
  mov bp, dx
  mov dx, [ax+2]
...
L129: ; Continuation
  ...
  push #L128
  mov cx, sp
  ;; (184'17) Tail: loop (f7) @ case_173'18 (arg)
  mov bp, [bp+7]
  mov dx, dx
  mov ax, [bp]
  jmp [ax]
...
L131: ; Continuation
  ...
  push #L130
  mov cx, sp
  ;; (48'23) Tail: app_48'20 (arg) @ xs (f7)
  ;; use temp ax while setting up bp/dx
  mov ax, bp
  mov bp, dx
  mov dx, [ax+7]
...
L132: ; Continuation
  ...
  push #L131
  mov cx, sp
  ;; (48'20) Tail: revloop (g9) @ con_48'20 (g37)
  mov bp, #g9
  mov dx, #g37
  mov ax, [bp]
  jmp [ax]
...
L133: ; Continuation
  ...
  push #L132
  mov cx, sp
  ;; (165'37) Tail: app_165'34 (f5) @ app_165'46 (arg)
  mov bp, [bp+5]
  mov dx, dx
  mov ax, [bp]
  jmp [ax]
...
L134: ; Continuation
  ...
  push #L133
  mov cx, sp
  ;; (165'46) Tail: explode (f2) @ line (f7)
  mov dx, [bp+7]
  mov bp, [bp+2]
  mov ax, [bp]
  jmp [ax]
...
L135: ; Continuation
  ...
  push #L134
  mov cx, sp
  ;; (165'34) Tail: at_word_start (f5) @ con_165'34 (g36)
  mov bp, [bp+5]
  mov dx, #g36
  mov ax, [bp]
  jmp [ax]
...
L136: ; Continuation
  ...
  push #L135
  mov cx, sp
  ;; (214'20) Tail: app_214'15 (arg) @ single_controlD (f8)
  ;; use temp ax while setting up bp/dx
  mov ax, bp
  mov bp, dx
  mov dx, [ax+8]
...
L137: ; Continuation
  ...
  push #L136
  mov cx, sp
  ;; (214'15) Tail: eq_string (f3) @ line (arg)
  mov bp, [bp+3]
  mov dx, dx
  mov ax, [bp]
  jmp [ax]
...
L138: ; Continuation
  ...
  push #L137
  mov cx, sp
  ;; (146'11) Tail: readloop (t1) @ con_146'11 (g34)
  mov bp, [1]
  mov dx, #g34
  mov ax, [bp]
  jmp [ax]
...
L139: ; Continuation
  ...
  push #L138
  mov cx, sp
  ;; (212'32) Tail: implode (f2) @ con_0'0 (t1)
  mov bp, [bp+2]
  mov dx, [1]
  mov ax, [bp]
  jmp [ax]
...
L141: ; Function: t3
  ...
  push #L140
  mov cx, sp
  ;; (115'38) Tail: explode (f3) @ lit_211'13 (g28)
  mov bp, [bp+3]
  mov dx, #g28
  mov ax, [bp]
  jmp [ax]
...
L144: ; Arm: 220'9
  ...
  push #L143
  mov cx, sp
  ;; (115'38) Tail: explode (f1) @ lit_220'23 (g62)
  mov bp, [bp+1]
  mov dx, #g62
  mov ax, [bp]
  jmp [ax]
...
L154: ; Continuation
  ...
  push #L153
  mov cx, sp
  ;; (224'43) Tail: app_224'33 (f3) @ case_173'18 (arg)
  mov bp, [bp+3]
  mov dx, dx
  mov ax, [bp]
  jmp [ax]
...
L156: ; Function: t1
  ...
  push #L155
  mov cx, sp
  ;; (224'33) Tail: map (g3) @ lam_223'19 (g63)
  mov bp, #g3
  mov dx, #g63
  mov ax, [bp]
  jmp [ax]
...
L160: ; Arm: 236'7
  ...
  push #L159
  mov cx, sp
  ;; (115'38) Tail: explode (f1) @ lit_236'22 (g68)
  mov bp, [bp+1]
  mov dx, #g68
  mov ax, [bp]
  jmp [ax]
...
L164: ; Continuation
  ...
  push #L163
  mov cx, sp
  ;; (182'28) Tail: app_182'23 (arg) @ x (f2)
  ;; use temp ax while setting up bp/dx
  mov ax, bp
  mov bp, dx
  mov dx, [ax+2]
...
L173: ; Arm: 229'11
  ...
  push #L172
  mov cx, sp
  ;; (229'33) Tail: concat (f3) @ con_229'34 (t2)
  mov bp, [bp+3]
  mov dx, [2]
  mov ax, [bp]
  jmp [ax]
...
L178: ; Continuation
  ...
  push #L177
  mov cx, sp
  ;; (233'48) Tail: concat (f3) @ con_233'49 (t5)
  mov bp, [bp+3]
  mov dx, [5]
  mov ax, [bp]
  jmp [ax]
...
L179: ; Continuation
  ...
  push #L178
  mov cx, sp
  ;; (184'17) Tail: loop (f5) @ case_173'18 (arg)
  mov bp, [bp+5]
  mov dx, dx
  mov ax, [bp]
  jmp [ax]
...
L182: ; Continuation
  ...
  push #L181
  mov cx, sp
  ;; (237'32) Tail: app_237'27 (arg) @ xs (f3)
  ;; use temp ax while setting up bp/dx
  mov ax, bp
  mov bp, dx
  mov dx, [ax+3]
...
L183: ; Continuation
  ...
  push #L182
  mov cx, sp
  ;; (237'27) Tail: iter (g5) @ lam_227'11 (t1)
  mov bp, #g5
  mov dx, [1]
  mov ax, [bp]
  jmp [ax]
...
L186: ; Arm: 229'11
  ...
  push #L185
  mov cx, sp
  ;; (229'33) Tail: concat (f4) @ con_229'34 (t2)
  mov bp, [bp+4]
  mov dx, [2]
  mov ax, [bp]
  jmp [ax]
...
L191: ; Continuation
  ...
  push #L190
  mov cx, sp
  ;; (233'48) Tail: concat (f4) @ con_233'49 (t5)
  mov bp, [bp+4]
  mov dx, [5]
  mov ax, [bp]
  jmp [ax]
...
L192: ; Continuation
  ...
  push #L191
  mov cx, sp
  ;; (184'17) Tail: loop (f8) @ case_173'18 (arg)
  mov bp, [bp+8]
  mov dx, dx
  mov ax, [bp]
  jmp [ax]
...
L197: ; Arm: 250'7
  ...
  push #L196
  mov cx, sp
  ;; (115'38) Tail: explode (f1) @ lit_250'22 (g89)
  mov bp, [bp+1]
  mov dx, #g89
  mov ax, [bp]
  jmp [ax]
...
L206: ; Continuation
  ...
  push #L205
  mov cx, sp
  ;; (182'28) Tail: app_182'23 (arg) @ name (f2)
  ;; use temp ax while setting up bp/dx
  mov ax, bp
  mov bp, dx
  mov dx, [ax+2]
...
L210: ; Arm: 243'11
  ...
  push #L209
  mov cx, sp
  ;; (241'35) Tail: concat (f3) @ con_241'36 (t2)
  mov bp, [bp+3]
  mov dx, [2]
  mov ax, [bp]
  jmp [ax]
...
L213: ; Arm: 246'16
  ...
  push #L212
  mov cx, sp
  ;; (241'35) Tail: concat (f3) @ con_241'36 (t4)
  mov bp, [bp+3]
  mov dx, [4]
  mov ax, [bp]
  jmp [ax]
...
L219: ; Continuation
  ...
  push #L218
  mov cx, sp
  ;; (251'32) Tail: app_251'27 (arg) @ xs (f3)
  ;; use temp ax while setting up bp/dx
  mov ax, bp
  mov bp, dx
  mov dx, [ax+3]
...
L220: ; Continuation
  ...
  push #L219
  mov cx, sp
  ;; (251'27) Tail: iter (g5) @ lam_240'11 (t1)
  mov bp, #g5
  mov dx, [1]
  mov ax, [bp]
  jmp [ax]
...
L223: ; Arm: 243'11
  ...
  push #L222
  mov cx, sp
  ;; (241'35) Tail: concat (f4) @ con_241'36 (t2)
  mov bp, [bp+4]
  mov dx, [2]
  mov ax, [bp]
  jmp [ax]
...
L226: ; Arm: 246'16
  ...
  push #L225
  mov cx, sp
  ;; (241'35) Tail: concat (f4) @ con_241'36 (t4)
  mov bp, [bp+4]
  mov dx, [4]
  mov ax, [bp]
  jmp [ax]
...
L234: ; Arm: 268'7
  ...
  push #L233
  mov cx, sp
  ;; (115'38) Tail: explode (f1) @ lit_268'22 (g110)
  mov bp, [bp+1]
  mov dx, #g110
  mov ax, [bp]
  jmp [ax]
...
L238: ; Arm: 256'9
  ...
  push #L237
  mov cx, sp
  ;; (257'26) Tail: concat (f3) @ con_257'27 (t2)
  mov bp, [bp+3]
  mov dx, [2]
  mov ax, [bp]
  jmp [ax]
...
L242: ; Continuation
  ...
  push #L241
  mov cx, sp
  ;; (261'28) Tail: app_261'23 (arg) @ sought (f2)
  ;; use temp ax while setting up bp/dx
  mov ax, bp
  mov bp, dx
  mov dx, [ax+2]
...
L243: ; Function: t1
  ...
  push #L242
  mov cx, sp
  ;; (261'23) Tail: eq_string (f2) @ name (t3)
  mov bp, [bp+2]
  mov dx, [3]
  mov ax, [bp]
  jmp [ax]
...
L245: ; Continuation
  ...
  push #L244
  mov cx, sp
  ;; (263'17) Tail: loop (f2) @ case_173'18 (arg)
  mov bp, [bp+2]
  mov dx, dx
  mov ax, [bp]
  jmp [ax]
...
L248: ; Continuation
  ;; (269'29) Tail: app_269'26 (arg) @ args (f2)
  ;; use temp ax while setting up bp/dx
  mov ax, bp
  mov bp, dx
  mov dx, [ax+2]
...
L249: ; Continuation
  ...
  push #L248
  mov cx, sp
  ;; (269'26) Tail: app_269'22 (arg) @ fs (f2)
  ;; use temp ax while setting up bp/dx
  mov ax, bp
  mov bp, dx
  mov dx, [ax+2]
...
L250: ; Function: t1
  ...
  push #L249
  mov cx, sp
  ;; (269'22) Tail: fold_left (g7) @ lam_253'8 (t3)
  mov bp, #g7
  mov dx, [3]
  mov ax, [bp]
  jmp [ax]
...
L254: ; Arm: 273'7
  ...
  push #L253
  mov cx, sp
  ;; (115'38) Tail: explode (f1) @ lit_273'22 (g118)
  mov bp, [bp+1]
  mov dx, #g118
  mov ax, [bp]
  jmp [ax]
...
L258: ; Arm: 276'10
  ...
  push #L257
  mov cx, sp
  ;; (276'33) Tail: concat (f3) @ con_276'34 (t4)
  mov bp, [bp+3]
  mov dx, [4]
  mov ax, [bp]
  jmp [ax]
...
L261: ; Arm: 279'12
  ...
  push #L260
  mov cx, sp
  ;; (115'38) Tail: explode (f1) @ lit_279'27 (g123)
  mov bp, [bp+1]
  mov dx, #g123
  mov ax, [bp]
  jmp [ax]
...
L265: ; Continuation
  ...
  push #L264
  mov cx, sp
  ;; (182'28) Tail: app_182'23 (arg) @ source (f2)
  ;; use temp ax while setting up bp/dx
  mov ax, bp
  mov bp, dx
  mov dx, [ax+2]
...
L270: ; Arm: 282'15
  ...
  push #L269
  mov cx, sp
  ;; (282'38) Tail: concat (f3) @ con_282'39 (t2)
  mov bp, [bp+3]
  mov dx, [2]
  mov ax, [bp]
  jmp [ax]
...
L278: ; Arm: 288'7
  ...
  push #L277
  mov cx, sp
  ;; (115'38) Tail: explode (f1) @ lit_288'22 (g131)
  mov bp, [bp+1]
  mov dx, #g131
  mov ax, [bp]
  jmp [ax]
...
L282: ; Arm: 291'10
  ...
  push #L281
  mov cx, sp
  ;; (291'33) Tail: concat (f3) @ con_291'34 (t4)
  mov bp, [bp+3]
  mov dx, [4]
  mov ax, [bp]
  jmp [ax]
...
L285: ; Arm: 294'12
  ...
  push #L284
  mov cx, sp
  ;; (115'38) Tail: explode (f1) @ lit_294'27 (g136)
  mov bp, [bp+1]
  mov dx, #g136
  mov ax, [bp]
  jmp [ax]
...
L294: ; Arm: 297'15
  ...
  push #L293
  mov cx, sp
  ;; (297'38) Tail: concat (f4) @ con_297'39 (t2)
  mov bp, [bp+4]
  mov dx, [2]
  mov ax, [bp]
  jmp [ax]
...
L302: ; Continuation
  ...
  push #L301
  mov cx, sp
  ;; (261'28) Tail: app_261'23 (arg) @ source (f2)
  ;; use temp ax while setting up bp/dx
  mov ax, bp
  mov bp, dx
  mov dx, [ax+2]
...
L305: ; Continuation
  ...
  push #L304
  mov cx, sp
  ;; (263'17) Tail: loop (f4) @ case_173'18 (arg)
  mov bp, [bp+4]
  mov dx, dx
  mov ax, [bp]
  jmp [ax]
...
L310: ; Continuation
  ...
  push #0
  mov 26, sp
  ;; (322'11) Tail: mainloop (f5) @ con_309'13 (t26)
  mov bp, [bp+5]
  mov dx, [26]
  mov ax, [bp]
  jmp [ax]
...
L312: ; Continuation
  ...
  push #L311
  mov cx, sp
  ;; (115'38) Tail: explode (f4) @ lit_321'13 (g55)
  mov bp, [bp+4]
  mov dx, #g55
  mov ax, [bp]
  jmp [ax]
...
L313: ; Continuation
  ...
  push #L312
  mov cx, sp
  ;; (80'25) Tail: block (g1) @ lam_80'30 (g23)
  mov bp, #g1
  mov dx, #g23
  mov ax, [bp]
  jmp [ax]
...
L314: ; Continuation
  ...
  push #L313
  mov cx, sp
  ;; (73'23) Tail: block (g1) @ lam_73'28 (g15)
  mov bp, #g1
  mov dx, #g15
  mov ax, [bp]
  jmp [ax]
...
L315: ; Continuation
  ...
  push #L314
  mov cx, sp
  ;; (62'30) Tail: block (g1) @ lam_62'35 (g13)
  mov bp, #g1
  mov dx, #g13
  mov ax, [bp]
  jmp [ax]
...
L316: ; Start
  ...
  push #L315
  mov cx, sp
  ;; (52'23) Tail: block (g1) @ lam_52'28 (g11)
  mov bp, #g1
  mov dx, #g11
  mov ax, [bp]
  jmp [ax]

...
let y = Nil0 in
let lit_0'0 = '\EOT' in
let single_controlD = Cons1[lit_0'0,y] in
    ...
    let k [eq_list,append,map,length,put_chars,fib,fact,single_controlD,mainloop] xs =
      let lam_0'0 = fun [] x k ->
        let lam_0'0 = fun [x] y k ->
          ...
          k prim_0'0 in
        k lam_0'0 in
      let k [eq_list,append,map,length,put_chars,fib,fact,single_controlD,mainloop,xs] app_58'31 =
        let k [eq_list,append,map,length,put_chars,fib,fact,single_controlD,mainloop,xs] app_58'39 =
          let k [eq_list,append,map,length,put_chars,fib,fact,single_controlD,mainloop,xs] app_58'41 =
            ...
            | false0 ->
              ...
              let k [eq_list,append,map,length,put_chars,fib,fact,single_controlD,mainloop,xs] app_203'7 =
                let con_203'10 = Nil0 in
                let k [eq_list,append,map,length,put_chars,fib,fact,single_controlD,mainloop,xs] app_203'10 =
                    ...
                    | Cons1(command,args) ->
                      let lam_0'0 = fun [] x k ->
                        let lam_0'0 = fun [x] y k ->
                          ...
                          k prim_0'0 in
                        k lam_0'0 in
                      let k [eq_list,append,map,length,put_chars,fib,fact,single_controlD,xs,command,args] app_58'31 =
                        let k [eq_list,append,map,length,put_chars,fib,fact,single_controlD,xs,command,args] app_58'39 =
                          let lit_0'0 = 'f' in
                          let lit_0'0 = 'i' in
                          let lit_0'0 = 'b' in
                          let con_0'0 = CID0 in
                          ...
                          let con_0'0 = CID1[lit_0'0,con_0'0] in
                          let con_0'0 = CID1[lit_0'0,con_0'0] in
                          let k [eq_list,append,map,length,put_chars,fib,fact,single_controlD,xs,command,args] app_58'41 =
                            match app_58'41 with
                            | true1 ->
                              let lit_0'0 = 'f' in
                              let lit_0'0 = 'i' in
                            ...
                            | false0 ->
                              let lam_0'0 = fun [] x k ->
                                let lam_0'0 = fun [x] y k ->
                                  ...
                                  k prim_0'0 in
                                k lam_0'0 in
                              let k [eq_list,append,map,length,put_chars,fact,single_controlD,xs,command,args] app_58'31 =
                                let k [eq_list,append,map,length,put_chars,fact,single_controlD,xs,command,args] app_58'39 =
                                  let lit_0'0 = 'f' in
                                  let lit_0'0 = 'a' in
                                  let lit_0'0 = 'c' in
                                  let lit_0'0 = 't' in
                                  ...
                                  let con_0'0 = CID1[lit_0'0,con_0'0] in
                                  let con_0'0 = CID1[lit_0'0,con_0'0] in
                                  let k [eq_list,append,map,length,put_chars,fact,single_controlD,xs,command,args] app_58'41 =
                                    match app_58'41 with
                                    | true1 ->
                                      let lit_0'0 = 'f' in
                                      let lit_0'0 = 'a' in
                                    ...
                                    | false0 ->
                                      let lam_0'0 = fun [] x k ->
                                        let lam_0'0 = fun [x] y k ->
                                          ...
                                          k prim_0'0 in
                                        k lam_0'0 in
                                      let k [eq_list,append,map,length,put_chars,single_controlD,xs,command,args] app_58'31 =
                                        let k [eq_list,append,map,length,put_chars,single_controlD,xs,args] app_58'39 =
                                          let lit_0'0 = 'r' in
                                          let lit_0'0 = 'e' in
                                          let lit_0'0 = 'v' in
                                          let con_0'0 = CID0 in
                                          ...
                                          let con_0'0 = CID1[lit_0'0,con_0'0] in
                                          let con_0'0 = CID1[lit_0'0,con_0'0] in
                                          let k [eq_list,append,map,length,put_chars,single_controlD,xs,args] app_58'41 =
                                            match app_58'41 with
                                            | true1 ->
                                              match args with
                                              | Cons1(_,_) ->
                                                    ...
                                                    let k [eq_list,put_chars,single_controlD,loop] xs =
                                                      let lam_0'0 = fun [] x k ->
                                                        let lam_0'0 = fun [x] y k ->
                                                          ...
                                                          k prim_0'0 in
                                                        k lam_0'0 in
                                                      let k [put_chars,single_controlD,loop,xs] app_58'31 =
                                                        let k [put_chars,single_controlD,loop,xs] app_58'39 =

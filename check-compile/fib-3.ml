...
let con_20_9'17_g16 = Cons1[lit_18_9'17_g14,con_19_9'20_g15] in
let con_22_9'32_g17 = Nil0 in
let s_35_16'15_g18 = " --> " in
let x_37_0'0_g19 = '0' in
let y_42_0'0_g20 = 0 in
let y_43_0'0_g21 = 10 in
let y_48_0'0_g22 = 10 in
let y_50_0'0_g23 = 0 in
let lit_33_9'17_g24 = '0' in
let con_34_9'20_g25 = Nil0 in
let con_35_9'17_g26 = Cons1[lit_33_9'17_g24,con_34_9'20_g25] in
let con_37_9'32_g27 = Nil0 in
let x_53_0'0_g28 = '\n' in
  ...
  let k = [res_17_27'6_arg], fun [res_17_27'6_f1] __19_28'19_arg ->
    ...
    let k = [res_17_27'6_f1], fun [res_17_27'6_f1] uLET_9_3'6_arg ->
      let k = [res_17_27'6_f1], fun [res_17_27'6_f1] __34_29'11_arg ->
        let prim_23_0'0_t1 = PRIM_Explode(s_35_16'15_g18) in
        let k = [res_17_27'6_f1], fun [res_17_27'6_f1] __36_30'20_arg ->
          let ord0_38_3'6_t1 = PRIM_CharOrd(x_37_0'0_g19) in
          let loop_49_5'10_t2 = [ord0_38_3'6_t1], fun [ord0_38_3'6_f1] loop_40_5'10_me acc_39_5'15_arg k ->
            let lam_31_5'19_t1 = [ord0_38_3'6_f1,acc_39_5'15_arg,loop_40_5'10_me], fun [ord0_38_3'6_f1,acc_39_5'15_f2,loop_40_5'10_f3] i_41_5'19_arg k ->
              let uLET_25_0'0_t1 = PRIM_EqInt(i_41_5'19_arg,y_42_0'0_g20) in
              match uLET_25_0'0_t1 with
              | true1 -> k acc_39_5'15_f2
              | false0 ->
                let c_44_4'20_t2 = PRIM_ModInt(i_41_5'19_arg,y_43_0'0_g21) in

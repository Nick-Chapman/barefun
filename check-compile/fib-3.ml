...
let ::_g11 = fun x_arg k ->
  let v23_t1 = [x_arg], fun [x_f1] y_arg k ->
    ...
    k v22_t1 in
  k v23_t1 in
let u24_3'17_g12 = '0' in
let u29_6'11_g13 = 0 in
let u36_7'29_g14 = 10 in
let u39_7'44_g15 = 10 in
let u43_9'9_g16 = 0 in
let u45_9'16_g17 = '0' in
        ...
        let k = [acc_f1,char_of_digit_f2,i_arg,loop_f3], fun [acc_f1,char_of_digit_f2,i_f3,loop_f4] u27_6'11_arg ->
          ...
          | false0 ->
            let k = [i_f3], fun [i_f1] u30_7'11_arg ->
              ...
              let k = [], fun [] u38_7'43_arg -> u38_7'43_arg u39_7'44_g15 k in
              /_g3 i_f1 k in
            ...
            let k = [], fun [] u35_7'28_arg -> u35_7'28_arg u36_7'29_g14 k in
            %_g4 i_f3 k in
        let k = [], fun [] u28_6'9_arg -> u28_6'9_arg u29_6'11_g13 k in
        =_g6 i_arg k in
      k v40_t1 in
    let k = [i_f1,loop_t2], fun [i_f1,loop_f2] u41_9'9_arg ->
      ...
      | true1 ->
        let k = [], fun [] u44_9'20_arg ->
          let u46_9'23_t1 = Nil0 in
          u44_9'20_arg u46_9'23_t1 k in
        ::_g11 u45_9'16_g17 k
      | false0 ->
        let k = [i_f1], fun [i_f1] u47_9'36_arg -> u47_9'36_arg i_f1 k in
        let u48_9'36_t1 = Nil0 in
        loop_f2 u48_9'36_t1 k in
    let k = [], fun [] u42_9'7_arg -> u42_9'7_arg u43_9'9_g16 k in
    =_g6 i_f1 k in
  ord_g7 u24_3'17_g12 k in
...
let u52_20'26_g22 = '\n' in
let newline_g23 = fun __arg k -> put_char_g10 u52_20'26_g22 k in
let u55_24'9_g24 = 2 in
let u60_24'30_g25 = 1 in
let u64_24'42_g26 = 2 in
  ...
  let k = [fib_me,n_arg], fun [fib_f1,n_f2] u53_24'9_arg ->
    ...
    | false0 ->
      let k = [fib_f1,n_f2], fun [fib_f1,n_f2] u56_24'33_arg ->
        ...
        let k = [], fun [] u63_24'41_arg -> u63_24'41_arg u64_24'42_g26 k in
        -_g2 n_f2 k in
      let k = [], fun [] u57_24'27_arg -> +_g1 u57_24'27_arg k in
      let k = [fib_f1], fun [fib_f1] u58_24'30_arg -> fib_f1 u58_24'30_arg k in
      let k = [], fun [] u59_24'29_arg -> u59_24'29_arg u60_24'30_g25 k in
      -_g2 n_f2 k in
  let k = [], fun [] u54_24'7_arg -> u54_24'7_arg u55_24'9_g24 k in
  <_g5 n_arg k in
let u65_28'13_g28 = "fib " in
let u66_30'13_g29 = " --> " in
    ...
    let k = [n_f1,res_arg], fun [n_f1,res_f2] __arg ->
      let k = [res_f2], fun [res_f1] __arg ->
        let k = [res_f1], fun [res_f1] __arg ->
          let k = [], fun [] __arg ->
            let u67_32'10_t1 = Unit0 in
            newline_g23 u67_32'10_t1 k in
          put_int_g21 res_f1 k in
        put_string_g20 u66_30'13_g29 k in
      put_int_g21 n_f1 k in
    put_string_g20 u65_28'13_g28 k in
  fib_g27 n_arg k in
let u68_34'21_g31 = 20 in
let main_g32 = fun __arg k -> runfib_g30 u68_34'21_g31 k in
let u69_0'0_t1 = Unit0 in
main_g32 u69_0'0_t1 k

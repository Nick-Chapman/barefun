...
let put_chars_90'8 =
  fix (fun put_chars_90'8 xs_90'18 ->
    match xs_90'18 with
    | Nil0 -> Unit0
...
let read_line_101'4 =
  (fun __101'14 ->
    ...
    let loop_103'10 =
      fix (fun loop_103'10 acc_103'15 ->
            ...
            | false0 ->
              ...
              | true1 ->
                ...
                | Cons1(c_112'14,tail_112'17) ->
                  let __113'58 =
                    match ((<=_8'4 (ord_0'0 c_112'14)) 26) with
...
let fallback_183'4 =
  (fun line_183'13 ->
    ...
    (newline_99'4 Unit0)) in
let split_words_192'4 =
  (fun s_192'16 ->
    let loop_193'10 =
      fix (fun loop_193'10 accWs_193'15 ->
        (fun accCs_193'21 ->
          (fun xs_193'27 ->
...
let mainloop_213'8 =
  fix (fun mainloop_213'8 __213'17 ->

...
let ::_0'0_g5 = fun x_0'0_arg k ->
  let lam_23_0'0_t1 = [x_0'0_arg], fun [x_0'0_f1] y_0'0_arg k ->
    ...
    k con_22_0'0_t1 in
  k lam_23_0'0_t1 in
let con_24_4'10_g6 = Unit0 in
let put_chars_2'8_g7 = fun put_chars_2'8_me xs_2'18_arg k ->
  match xs_2'18_arg with
  | Nil0 -> k con_24_4'10_g6
...
let put_string_7'4_g8 = fun s_7'15_arg k ->
  let k = [], fun [] app_25_7'38_arg -> put_chars_2'8_g7 app_25_7'38_arg k in
  explode_0'0_g2 s_7'15_arg k in
let revloop_10'10_g9 = fun revloop_10'10_me acc_10'18_arg k ->
...
let con_31_15'10_g10 = Nil0 in
let reverse_9'4_g11 = fun ysStart_9'12_arg k ->
  let k = [ysStart_9'12_arg], fun [ysStart_9'12_f1] app_30_15'10_arg -> app_30_15'10_arg ysStart_9'12_f1 k in
  revloop_10'10_g9 con_31_15'10_g10 k in
let lit_32_17'26_g12 = '\n' in
let newline_17'4_g13 = fun __17'12_arg k -> put_char_0'0_g3 lit_32_17'26_g12 k in
let con_33_21'27_g14 = Unit0 in
let lit_36_23'22_g15 = '\n' in
let con_37_23'40_g16 = Unit0 in
let readloop_20'10_g17 = fun readloop_20'10_me sofar_20'19_arg k ->
  let k = [readloop_20'10_me,sofar_20'19_arg], fun [readloop_20'10_f1,sofar_20'19_f2] theChar_21'8_arg ->
    ...
    let k = [readloop_20'10_f1,sofar_20'19_f2,gotten_22'8_arg], fun [readloop_20'10_f1,sofar_20'19_f2,gotten_22'8_f3] app_35_23'15_arg ->
      let k = [readloop_20'10_f1,sofar_20'19_f2,gotten_22'8_f3], fun [readloop_20'10_f1,sofar_20'19_f2,gotten_22'8_f3] app_34_23'22_arg ->
        ...
        | true1 ->
          let k = [sofar_20'19_f2], fun [sofar_20'19_f1] __23'42_arg -> reverse_9'4_g11 sofar_20'19_f1 k in
          newline_17'4_g13 con_37_23'40_g16 k
        | false0 ->
      ...
      app_35_23'15_arg lit_36_23'22_g15 k in
    eq_char_0'0_g1 gotten_22'8_arg k in
  get_char_0'0_g4 con_33_21'27_g14 k in
let con_40_26'11_g18 = Nil0 in
let read_line_19'4_g19 = fun __19'14_arg k -> readloop_20'10_g17 con_40_26'11_g18 k in
let lit_41_28'20_g20 = "LOAD\n" in
let lit_42_31'13_g21 = "> " in
let con_44_32'23_g22 = Unit0 in
let con_45_33'9_g23 = Unit0 in
let con_46_34'10_g24 = Unit0 in
let mainloop_30'8_g25 = fun mainloop_30'8_me __30'17_arg k ->
  let k = [mainloop_30'8_me], fun [mainloop_30'8_f1] __31'17_arg ->
    let k = [mainloop_30'8_f1], fun [mainloop_30'8_f1] app_43_32'23_arg ->
      let k = [mainloop_30'8_f1], fun [mainloop_30'8_f1] __32'26_arg ->
        let k = [mainloop_30'8_f1], fun [mainloop_30'8_f1] __33'11_arg -> mainloop_30'8_f1 con_46_34'10_g24 k in
        newline_17'4_g13 con_45_33'9_g23 k in
      put_chars_2'8_g7 app_43_32'23_arg k in
    read_line_19'4_g19 con_44_32'23_g22 k in
  put_string_7'4_g8 lit_42_31'13_g21 k in
let lit_47_37'13_g26 = "RUN\n" in
let con_48_38'20_g27 = Unit0 in
let lit_49_39'13_g28 = "NEVER\n" in
let main_36'4_g29 = fun __36'9_arg k ->
  let k = [], fun [] __37'20_arg ->
    let k = [], fun [] __38'6_arg -> put_string_7'4_g8 lit_49_39'13_g28 k in
    mainloop_30'8_g25 con_48_38'20_g27 k in
  put_string_7'4_g8 lit_47_37'13_g26 k in
let con_50_0'0_g30 = Unit0 in
let k = [], fun [] __28'4_arg -> main_36'4_g29 con_50_0'0_g30 k in
put_string_7'4_g8 lit_41_28'20_g20 k

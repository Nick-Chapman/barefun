    ...
    let loop_103'10_t1 = [controlD_102'6_arg], fun [controlD_102'6_f1] loop_103'10_me acc_103'15_arg k ->
      let k = [controlD_102'6_f1,loop_103'10_me,acc_103'15_arg], fun [controlD_102'6_f1,loop_103'10_f2,acc_103'15_f3] c_104'8_arg ->
        let k = [controlD_102'6_f1,loop_103'10_f2,acc_103'15_f3,c_104'8_arg], fun [controlD_102'6_f1,loop_103'10_f2,acc_103'15_f3,c_104'8_f4] n_105'8_arg ->
          let k = [controlD_102'6_f1,loop_103'10_f2,acc_103'15_f3,c_104'8_f4,n_105'8_arg], fun [controlD_102'6_f1,loop_103'10_f2,acc_103'15_f3,c_104'8_f4,n_105'8_f5] app_144_106'17_arg ->
            ...
            | false0 ->
              let k = [controlD_102'6_f1,loop_103'10_f2,acc_103'15_f3,c_104'8_f4,n_105'8_f5], fun [controlD_102'6_f1,loop_103'10_f2,acc_103'15_f3,c_104'8_f4,n_105'8_f5] app_148_107'19_arg ->
                ...
                | true1 ->
                  let k = [controlD_102'6_f1,acc_103'15_f3], fun [controlD_102'6_f1,acc_103'15_f2] __107'44_arg ->
                    let k = [controlD_102'6_f1,acc_103'15_f2], fun [controlD_102'6_f1,acc_103'15_f2] __107'55_arg ->
                      ...
                      let k = [acc_103'15_f2], fun [acc_103'15_f1] app_152_107'75_arg -> app_152_107'75_arg acc_103'15_f1 k in
                ...
                | false0 ->
                  let k = [loop_103'10_f2,acc_103'15_f3,c_104'8_f4,n_105'8_f5], fun [loop_103'10_f1,acc_103'15_f2,c_104'8_f3,n_105'8_f4] app_153_108'15_arg ->
                      ...
                      let k = [loop_103'10_f1,acc_103'15_f2,c_104'8_f3], fun [loop_103'10_f1,acc_103'15_f2,c_104'8_f3] app_156_109'17_arg ->
                        ...
                        | true1 ->
                          ...
                          | Cons1(c_112'14_t1,tail_112'17_t2) ->
                            let k = [loop_103'10_f1,tail_112'17_t2], fun [loop_103'10_f1,tail_112'17_f2] __113'58_arg ->
                            ...
                            let k = [], fun [] app_160_113'25_arg -> app_160_113'25_arg lit_162_113'28_g63 k in
                            let k = [], fun [] app_161_113'23_arg -> <=_8'4_g17 app_161_113'23_arg k in
                        ...
                        | false0 ->
                          let k = [loop_103'10_f1,acc_103'15_f2,c_104'8_f3], fun [loop_103'10_f1,acc_103'15_f2,c_104'8_f3] __117'23_arg ->
                            ...
                            let k = [acc_103'15_f2], fun [acc_103'15_f1] app_167_117'36_arg -> app_167_117'36_arg acc_103'15_f1 k in
                            cons_45'4_g37 c_104'8_f3 k in
                          put_char_12'4_g25 c_104'8_f3 k in
                      let k = [], fun [] app_157_109'15_arg -> app_157_109'15_arg lit_158_109'17_g62 k in
                      =_0'0_g7 n_105'8_f4 k in
                  let k = [], fun [] app_154_108'13_arg -> app_154_108'13_arg lit_155_108'15_g61 k in
                  >_7'4_g16 n_105'8_f5 k in
              let k = [controlD_102'6_f1], fun [controlD_102'6_f1] app_149_107'17_arg -> app_149_107'17_arg controlD_102'6_f1 k in
              eq_char_0'0_g8 c_104'8_f4 k in
          let k = [], fun [] app_145_106'15_arg -> app_145_106'15_arg lit_146_106'17_g60 k in
          eq_char_0'0_g8 c_104'8_f4 k in
...
let fib_121'8_g68 = fun fib_121'8_me n_121'12_arg k ->
  let k = [fib_121'8_me,n_121'12_arg], fun [fib_121'8_f1,n_121'12_f2] app_169_123'9_arg ->
    match app_169_123'9_arg with
    | true1 -> k n_121'12_f2
    | false0 ->
      let k = [fib_121'8_f1,n_121'12_f2], fun [fib_121'8_f1,n_121'12_f2] app_172_123'33_arg ->
        let k = [app_172_123'33_arg], fun [app_172_123'33_f1] app_177_123'39_arg -> app_172_123'33_f1 app_177_123'39_arg k in
        let k = [fib_121'8_f1], fun [fib_121'8_f1] app_178_123'42_arg -> fib_121'8_f1 app_178_123'42_arg k in
        let k = [], fun [] app_179_123'41_arg -> app_179_123'41_arg lit_180_123'42_g67 k in
        -_0'0_g2 n_121'12_f2 k in
      let k = [], fun [] app_173_123'27_arg -> +_0'0_g1 app_173_123'27_arg k in
      let k = [fib_121'8_f1], fun [fib_121'8_f1] app_174_123'30_arg -> fib_121'8_f1 app_174_123'30_arg k in
      let k = [], fun [] app_175_123'29_arg -> app_175_123'29_arg lit_176_123'30_g66 k in
      -_0'0_g2 n_121'12_f2 k in
  let k = [], fun [] app_170_123'7_arg -> app_170_123'7_arg lit_171_123'9_g65 k in
...
let fact_125'8_g72 = fun fact_125'8_me n_125'13_arg k ->
  let k = [fact_125'8_me,n_125'13_arg], fun [fact_125'8_f1,n_125'13_f2] app_181_127'10_arg ->
    match app_181_127'10_arg with
    | true1 ->
      let k = [n_125'13_f2], fun [n_125'13_f1] app_184_127'28_arg -> app_184_127'28_arg n_125'13_f1 k in
      let k = [], fun [] app_185_127'22_arg -> ( * )_0'0_g3 app_185_127'22_arg k in
      let k = [fact_125'8_f1], fun [fact_125'8_f1] app_186_127'25_arg -> fact_125'8_f1 app_186_127'25_arg k in
      let k = [], fun [] app_187_127'24_arg -> app_187_127'24_arg lit_188_127'25_g70 k in
      -_0'0_g2 n_125'13_f2 k
    | false0 -> k lit_189_127'37_g71 in
  let k = [], fun [] app_182_127'7_arg -> app_182_127'7_arg lit_183_127'10_g69 k in
...
let lam_221_184'30_g92 = fun c_184'30_arg k ->
  let k = [c_184'30_arg], fun [c_184'30_f1] app_222_184'48_arg ->
    match app_222_184'48_arg with
    | true1 -> k lit_225_184'57_g91
    | false0 -> k c_184'30_f1 in
  let k = [], fun [] app_223_184'46_arg -> app_223_184'46_arg lit_224_184'48_g90 k in
...
let fallback_183'4_g96 = fun line_183'13_arg k ->
  let k = [line_183'13_arg], fun [line_183'13_f1] star_the_ohs_184'6_arg ->
    let k = [line_183'13_f1,star_the_ohs_184'6_arg], fun [line_183'13_f1,star_the_ohs_184'6_f2] n_185'6_arg ->
      let k = [n_185'6_arg], fun [n_185'6_f1] __186'66_arg ->
      ...
      let k = [], fun [] app_226_186'46_arg -> put_chars_90'8_g54 app_226_186'46_arg k in
      let k = [line_183'13_f1,star_the_ohs_184'6_f2], fun [line_183'13_f1,star_the_ohs_184'6_f2] app_227_186'20_arg ->
        let k = [app_227_186'20_arg], fun [app_227_186'20_f1] app_230_186'60_arg -> app_227_186'20_f1 app_230_186'60_arg k in
        star_the_ohs_184'6_f2 line_183'13_f1 k in
      let k = [], fun [] app_228_186'29_arg -> append_58'8_g40 app_228_186'29_arg k in
  ...
  let lam_251_193'21_t1 = [loop_193'10_me,accWs_193'15_arg], fun [loop_193'10_f1,accWs_193'15_f2] accCs_193'21_arg k ->
    let lam_250_193'27_t1 = [loop_193'10_f1,accWs_193'15_f2,accCs_193'21_arg], fun [loop_193'10_f1,accWs_193'15_f2,accCs_193'21_f3] xs_193'27_arg k ->
      ...
      | Nil0 ->
        ...
        let k = [accWs_193'15_f2], fun [accWs_193'15_f1] app_235_195'35_arg -> app_235_195'35_arg accWs_193'15_f1 k in
        let k = [], fun [] app_236_195'29_arg -> ::_0'0_g14 app_236_195'29_arg k in
        reverse_63'4_g42 accCs_193'21_f3 k
      | Cons1(x_197'6_t1,xs_197'9_t2) ->
        let k = [loop_193'10_f1,accWs_193'15_f2,accCs_193'21_f3,x_197'6_t1,xs_197'9_t2], fun [loop_193'10_f1,accWs_193'15_f2,accCs_193'21_f3,x_197'6_f4,xs_197'9_f5] app_237_198'20_arg ->
          match app_237_198'20_arg with
          | true1 ->
            let k = [xs_197'9_f5], fun [xs_197'9_f1] app_240_198'59_arg -> app_240_198'59_arg xs_197'9_f1 k in
            let k = [], fun [] app_241_198'34_arg ->
              let con_245_198'59_t1 = Nil0 in
              app_241_198'34_arg con_245_198'59_t1 k in
            let k = [loop_193'10_f1], fun [loop_193'10_f1] app_242_198'52_arg -> loop_193'10_f1 app_242_198'52_arg k in
            let k = [accWs_193'15_f2], fun [accWs_193'15_f1] app_243_198'49_arg -> app_243_198'49_arg accWs_193'15_f1 k in
            let k = [], fun [] app_244_198'43_arg -> ::_0'0_g14 app_244_198'43_arg k in
            reverse_63'4_g42 accCs_193'21_f3 k
          | false0 ->
            let k = [xs_197'9_f5], fun [xs_197'9_f1] app_246_199'23_arg -> app_246_199'23_arg xs_197'9_f1 k in
            let k = [accCs_193'21_f3,x_197'6_f4], fun [accCs_193'21_f1,x_197'6_f2] app_247_199'17_arg ->
              let k = [app_247_199'17_arg], fun [app_247_199'17_f1] app_248_199'27_arg -> app_247_199'17_f1 app_248_199'27_arg k in
              let k = [accCs_193'21_f1], fun [accCs_193'21_f1] app_249_199'25_arg -> app_249_199'25_arg accCs_193'21_f1 k in
              ::_0'0_g14 x_197'6_f2 k in
            loop_193'10_f1 accWs_193'15_f2 k in
        let k = [], fun [] app_238_198'18_arg -> app_238_198'18_arg lit_239_198'20_g97 k in
        eq_char_0'0_g8 x_197'6_t1 k in
    k lam_250_193'27_t1 in
  k lam_251_193'21_t1 in
let split_words_192'4_g99 = fun s_192'16_arg k ->
  let k = [s_192'16_arg], fun [s_192'16_f1] app_252_201'10_arg -> app_252_201'10_arg s_192'16_f1 k in
  let k = [], fun [] app_253_201'7_arg ->
...
let lit_281_220'13_g105 = "This is a shell prototype. Try: fib, fact, rev\n" in
let k = [], fun [] single_controlD_166'4_arg ->
  let rev_168'4_t1 = [single_controlD_166'4_arg], fun [single_controlD_166'4_f1] __168'7_arg k ->
    let loop_169'10_t1 = [single_controlD_166'4_f1], fun [single_controlD_166'4_f1] loop_169'10_me __169'14_arg k ->
      let k = [single_controlD_166'4_f1,loop_169'10_me], fun [single_controlD_166'4_f1,loop_169'10_f2] xs_170'8_arg ->
        let k = [loop_169'10_f2,xs_170'8_arg], fun [loop_169'10_f1,xs_170'8_f2] app_211_171'23_arg ->
          ...
          | false0 ->
            ...
            let k = [], fun [] app_214_172'26_arg -> put_chars_90'8_g54 app_214_172'26_arg k in
            reverse_63'4_g42 xs_170'8_f2 k in
        let k = [single_controlD_166'4_f1], fun [single_controlD_166'4_f1] app_212_171'20_arg -> app_212_171'20_arg single_controlD_166'4_f1 k in
  ...
  let execute_203'4_t3 = [runrev_176'4_t2], fun [runrev_176'4_f1] line_203'12_arg k ->
    let k = [runrev_176'4_f1,line_203'12_arg], fun [runrev_176'4_f1,line_203'12_f2] words_204'6_arg ->
      ...
      | Cons1(command_207'4_t1,args_207'13_t2) ->
        let k = [runrev_176'4_f1,line_203'12_f2,command_207'4_t1,args_207'13_t2], fun [runrev_176'4_f1,line_203'12_f2,command_207'4_f3,args_207'13_f4] app_257_208'29_arg ->
          ...
          | false0 ->
            let k = [runrev_176'4_f1,line_203'12_f2,command_207'4_f3,args_207'13_f4], fun [runrev_176'4_f1,line_203'12_f2,command_207'4_f3,args_207'13_f4] app_261_209'31_arg ->
              ...
              | false0 ->
                let k = [runrev_176'4_f1,line_203'12_f2,args_207'13_f4], fun [runrev_176'4_f1,line_203'12_f2,args_207'13_f3] app_265_210'33_arg ->
                  match app_265_210'33_arg with
                  | true1 -> runrev_176'4_f1 args_207'13_f3 k
                  | false0 -> fallback_183'4_g96 line_203'12_f2 k in
                let k = [], fun [] app_266_210'25_arg ->
                  let k = [app_266_210'25_arg], fun [app_266_210'25_f1] app_267_210'42_arg -> app_266_210'25_f1 app_267_210'42_arg k in
                  explode_0'0_g11 lit_268_210'42_g102 k in
                eq_char_list_56'4_g39 command_207'4_f3 k in
            let k = [], fun [] app_262_209'23_arg ->
              let k = [app_262_209'23_arg], fun [app_262_209'23_f1] app_263_209'40_arg -> app_262_209'23_f1 app_263_209'40_arg k in
              explode_0'0_g11 lit_264_209'40_g101 k in
            eq_char_list_56'4_g39 command_207'4_f3 k in
        let k = [], fun [] app_258_208'21_arg ->
          let k = [app_258_208'21_arg], fun [app_258_208'21_f1] app_259_208'38_arg -> app_258_208'21_f1 app_259_208'38_arg k in
  ...
  let mainloop_213'8_t4 = [single_controlD_166'4_arg,execute_203'4_t3], fun [single_controlD_166'4_f1,execute_203'4_f2] mainloop_213'8_me __213'17_arg k ->
    let k = [single_controlD_166'4_f1,execute_203'4_f2,mainloop_213'8_me], fun [single_controlD_166'4_f1,execute_203'4_f2,mainloop_213'8_f3] __214'21_arg ->
      let k = [single_controlD_166'4_f1,execute_203'4_f2,mainloop_213'8_f3], fun [single_controlD_166'4_f1,execute_203'4_f2,mainloop_213'8_f3] xs_215'6_arg ->
        let k = [execute_203'4_f2,mainloop_213'8_f3,xs_215'6_arg], fun [execute_203'4_f1,mainloop_213'8_f2,xs_215'6_f3] app_277_216'21_arg ->
          match app_277_216'21_arg with
          | true1 ->
            let con_279_216'42_t1 = Unit0 in
            k con_279_216'42_t1
          | false0 ->
            let k = [mainloop_213'8_f2], fun [mainloop_213'8_f1] __217'15_arg ->
              let con_280_217'26_t1 = Unit0 in
              mainloop_213'8_f1 con_280_217'26_t1 k in
            execute_203'4_f1 xs_215'6_f3 k in
        let k = [single_controlD_166'4_f1], fun [single_controlD_166'4_f1] app_278_216'18_arg -> app_278_216'18_arg single_controlD_166'4_f1 k in
        eq_char_list_56'4_g39 xs_215'6_arg k in
      let con_276_215'21_t1 = Unit0 in
      read_line_101'4_g64 con_276_215'21_t1 k in
    let k = [], fun [] con_269_214'13_arg -> put_chars_90'8_g54 con_269_214'13_arg k in
    let k = [], fun [] con_271_214'17_arg ->
      let con_275_214'13_t1 = Cons1[lit_270_214'13_g103,con_271_214'17_arg] in
      k con_275_214'13_t1 in
    let con_273_214'20_t1 = Nil0 in
    let con_274_214'17_t2 = Cons1[lit_272_214'17_g104,con_273_214'20_t1] in
    k con_274_214'17_t2 in
  let main_219'4_t5 = [mainloop_213'8_t4], fun [mainloop_213'8_f1] __219'9_arg k ->
    let k = [mainloop_213'8_f1], fun [mainloop_213'8_f1] __220'63_arg ->
      let con_282_221'11_t1 = Unit0 in
      mainloop_213'8_f1 con_282_221'11_t1 k in
    put_string_95'4_g55 lit_281_220'13_g105 k in
  let con_283_0'0_t6 = Unit0 in
  main_219'4_t5 con_283_0'0_t6 k in
let k = [], fun [] app_206_166'28_arg ->
  let con_209_166'31_t1 = Nil0 in
  app_206_166'28_arg con_209_166'31_t1 k in
let k = [], fun [] app_207_166'26_arg -> ::_0'0_g14 app_207_166'26_arg k in

...
let put_string_newline_g49 =
  (fun s_arg k ->
    let k = [], fun [] __arg ->
      let u123_t1 = Tag_0 in
...
let runfib_g74 =
  (fun args_arg k ->
    let k = [args_arg], fun [args_f1] __arg ->
      match args_f1 with
      | Tag_0 -> error_g68 u170_g70 k
      | Tag_1(arg1_t1,more_t2) ->
        match more_t2 with
        | Tag_1(__t3,__t4) -> error_g68 u171_g71 k
        | Tag_0 ->
          let k = [], fun [] u172_arg ->
            match u172_arg with
            | Tag_1 -> error_g68 u173_g72 k
            | Tag_0(n_t1) ->
              let k = [n_t1], fun [n_f1] res_arg ->
                let k = [res_arg], fun [res_f1] __arg ->
                  let k = [res_f1], fun [res_f1] __arg ->
                    let k = [], fun [] __arg ->
                      let u175_t1 = Tag_0 in
...
let runfact_g80 =
  (fun args_arg k ->
    let k = [args_arg], fun [args_f1] __arg ->
      match args_f1 with
      | Tag_0 -> error_g68 u177_g76 k
      | Tag_1(arg1_t1,more_t2) ->
        match more_t2 with
        | Tag_1(__t3,__t4) -> error_g68 u178_g77 k
        | Tag_0 ->
          let k = [], fun [] u179_arg ->
            match u179_arg with
            | Tag_1 -> error_g68 u180_g78 k
            | Tag_0(n_t1) ->
              let k = [n_t1], fun [n_f1] res_arg ->
                let k = [res_arg], fun [res_f1] __arg ->
                  let k = [res_f1], fun [res_f1] __arg ->
                    let k = [], fun [] __arg ->
                      let u182_t1 = Tag_0 in
...
let split_words_g92 =
  (fun s_arg k ->
    ...
    let k = [], fun [] u219_arg ->
      let u221_t1 = Tag_0 in
      u219_arg u221_t1 k in
    let u220_t1 = Tag_0 in
